                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="text" class="form-control contact-form__input" id="inputMail" name="email" placeholder="Enter your last name">
                                    </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-12">
                                        ...
                                        <input type="email" class="form-control contact-form__input" id="inputPhone" name="phone" placeholder="Enter your email">
                                    </div>
                                    </div>
                                </div>
                                    <div class="form-group mrb-small contact-form__group">
